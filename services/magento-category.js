...
var MagentoCategoryService = /*#__PURE__*/function (_TransactionBaseServi) {
  (0, _inherits2["default"])(MagentoCategoryService, _TransactionBaseServi);
  var _super = _createSuper(MagentoCategoryService);
  function MagentoCategoryService(container, options) {
    var _this;
    (0, _classCallCheck2["default"])(this, MagentoCategoryService);
  ...
  (0, _createClass2["default"])(MagentoCategoryService, [{
    key: "create",
    value: function () {
                    ...
                    return _regenerator["default"].wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return _this2.productCollectionService_.withTransaction(manager).retrieveByHandle(_this2.getHandle(category))["catch"](function () {
                              return undefined;
                            });
                          case 2:
                          ...
                          case 5:
                            //create collection
                            collectionData = _this2.normalizeCollection(category);
                            _context.next = 8;
                    ...
                    return _regenerator["default"].wrap(function _callee3$(_context3) {
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            collectionData = _this3.normalizeCollection(category);
                            update = {};
    ...
    value: function normalizeCollection(category) {
      var _category$custom_attr;
      return {
        title: category.name,
        handle: (_category$custom_attr = category.custom_attributes.find(function (attribute) {
          return attribute.attribute_code === 'url_key';
        })) === null || _category$custom_attr === void 0 ? void 0 : _category$custom_attr.value,
        metadata: {
    ...
    value: function getHandle(category) {
      var _category$custom_attr2;
      return ((_category$custom_attr2 = category.custom_attributes.find(function (attribute) {
        return attribute.attribute_code === 'url_key';
      })) === null || _category$custom_attr2 === void 0 ? void 0 : _category$custom_attr2.value) || '';
    }
  }]);
  return MagentoCategoryService;
}(_medusa.TransactionBaseService);
var _default = MagentoCategoryService;
